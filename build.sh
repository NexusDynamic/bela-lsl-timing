...
BBB_ADDRESS="root@192.168.42.101" ../Bela/scripts/build_project.sh \
  -p bela-lsl-timing \
  -c "--board Bela --analog-channels 0 --digital-channels 16 --verbose --mute-speaker yes --use-analog no --use-digital yes --disable-led --period 16 --high-performance-mode" \
  --force \
  -m "CPPFLAGS='-std=c++1z -I/root/Bela/projects/bela-lsl-timing/include' LDLIBS=/root/Bela/projects/bela-lsl-timing/lib/liblsl.so" \
  ./
