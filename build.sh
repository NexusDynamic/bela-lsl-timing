...
BBB_ADDRESS="root@192.168.42.101" ../Bela/scripts/build_project.sh \
  -p bela-lsl-timing \
  -c "--analog-channels 2 --digital-channels 16 --audio-input-gain 0 --line-out-level 0 --hp-level 0 --verbose --mute-speaker 1 --use-analog 0 --use-digital 1 --disable-led --period 16 --high-performance-mode" \
  --force \
